...
backup_size = Histogram('backup_size', 'Size of the backup', unit='MiB', buckets=(16*MiB, 64*MiB, 256*MiB, 1*GiB, 2*GiB, 4*GiB, 8*GiB, 16*GiB, 32*GiB, 64*GiB, 128*GiB, 256*GiB, 512*GiB, 1024*GiB))
...
class BackupManager:
    expected_record = ' TABLE DATA public django_migrations '
...
if __name__ == '__main__':
    ...
    parser.add_argument('--interval', type=int, default=timedelta(minutes=10).total_seconds(), help='Refresh interval (s)')
